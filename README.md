...
1. Baixe a última versão na aba [Releases](https://github.com/claitonllemes/Sketch-Plugin/releases).
...
2. Execute o comando de release:
   ```bash
   npm run release
   # ou
   bun run release
   ```
3. Commit e Push das alterações (incluindo o `.appcast.json` atualizado):
   ```bash
   git add .
